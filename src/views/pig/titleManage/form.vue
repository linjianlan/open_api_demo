<template>
    <el-dialog :title="form.titbId ? '编辑' : '新增'" v-model="visible"
      :close-on-click-modal="false" draggable>
      <el-form ref="dataFormRef" :model="form" :rules="dataRules" formDialogRef label-width="90px" v-loading="loading">
       <el-row :gutter="24">
    <el-col :span="12" class="mb20">
      <el-form-item label="创建时间" prop="titbCreateTime">
            <el-date-picker type="datetime" placeholder="请选择创建时间" v-model="form.titbCreateTime" :value-format="dateTimeStr"></el-date-picker>
      </el-form-item>
      </el-col>


    <el-col :span="12" class="mb20">
      <el-form-item label="修改时间" prop="titbUpdateTime">
            <el-date-picker type="datetime" placeholder="请选择修改时间" v-model="form.titbUpdateTime" :value-format="dateTimeStr"></el-date-picker>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="创建人" prop="titbCreateBy">
        <el-input v-model="form.titbCreateBy" placeholder="请输入创建人"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="图标或图片路径" prop="titbIcon">
        <el-input v-model="form.titbIcon" placeholder="请输入图标或图片路径"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="级别 1 父级    1++...子级" prop="titbGrade">
        <el-input-number :min="1" :max="1000" v-model="form.titbGrade" placeholder="请输入级别 1 父级    1++...子级"></el-input-number>
      </el-form-item>
    </el-col>
...
import { getObj, addObj, putObj } from '/@/api/pig/titleManage'
...
// 定义校验规则
const dataRules = ref({
        titbCreateTime: [{required: true, message: '创建时间不能为空', trigger: 'blur'}],
        titbUpdateTime: [{required: true, message: '修改时间不能为空', trigger: 'blur'}],
        titbCreateBy: [{required: true, message: '创建人不能为空', trigger: 'blur'}],
